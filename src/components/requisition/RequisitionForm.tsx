    ...
    <div className="fixed inset-0 bg-black/60 backdrop-blur-md z-[100] flex items-center justify-center p-4">
      ...
      >
        <div className="p-6 border-b border-gray-100 flex items-center justify-between bg-white sticky top-0 z-10">
          <div>
            <h2 className="text-xl font-bold tracking-tight">Write Requisition</h2>
          ...
          <div className="flex-1 overflow-y-auto p-8 space-y-8 border-r border-gray-100">
            <div className="space-y-4">
              ...
              <input 
                ...
                className="w-full px-4 py-3 rounded-sm border border-gray-200 focus:border-black focus:ring-0 text-sm transition-all bg-gray-50/30"
                value={writtenTo}
